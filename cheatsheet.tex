...
class MMN11_Q1():
    ...
    def doSomething(self, param1, param2="default_value_for_param2"):
        """
        A short description of the function
        Do not forget to add remarks for any significant line of code
        Make sure to use meaningful names for your variables

        @param:
            param1 (int): The first parameter
            param2 (str): The second parameter. with default value "default_value_for_param2"
        @Returns:
            void
        """
        print(param1)
